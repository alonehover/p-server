...
const googleApi = require('translation-google');
...
export class TranslateService {
    ...
    async search(queryWords: string): Promise<any> {
        ...
        const google = await this.google(queryWords);
        ...
        const data = [
            ...
            { name: 'Google', key: 'google', data: google },
        ]
    ...
    async google(queryWords) {
        const res = await googleApi(queryWords, { to: hasChinese(queryWords) ? 'en' : 'zh-cn' }).then(res => {
